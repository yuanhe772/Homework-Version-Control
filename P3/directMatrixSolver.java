 ...
 * 
 * Project 3, Task 1 - Direct Full-matrix Solver:
 * The intuition of this direct matrix solver:
 * 
 * 
 */
...
public class directMatrixSolver {
	...
	/** Return the pivot's column in a row in A (Choose the left one when tie occurs)*/
	...
	/** Permute to have the prior rows having more sparsity*/
	...
	/** Check if row r in A has only 1 non-zero element*/
	...
	/** Search for the pivot in A, and return its col index*/
	...
	public static HashMap<Integer, Double> directSolver(FullMatrix A, Vector V){
