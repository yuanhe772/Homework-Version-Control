...
public class Solvers {
	 ...
	 * 			 Functions are chosen according to the input String fType
	...
	public static double i(double t) {
		...
		if(remainder>=0 && remainder<1) 
			...
			return (-0.1*remainder+1.1)*0.001;
		else return 0;
	}
	 ...
	 * @return: double r*/
	public static double r(ArrayList<Vector> xRK3_xRK4, int i) {
		double xRK3 = xRK3_xRK4.get(0).v[i];
		double xRK4 = xRK3_xRK4.get(1).v[i];
		double E = Math.abs(xRK3 - xRK4);
		double r = E / ((xRK4+eA)*eR);
		return r;
	}
