...
public class Main {
	...
	public static void main(String args[]) throws Exception {
		...
		// ill-conditioned matrix in Note4, slide 50
		double[][] A = {{1970,1},{1, -0.8631}};
		double[] V = {19720, 7.631};
		Test.testDirectSolver(new FullMatrix(A), new Vector(V));
		
		// Matrix with rank at least 4
		double[][] A2 = {{1,2,0,0,3},{4,5,6,0,0},{0,7,8,0,9},{0,0,0,10,0},{11,0,0,0,12}};
		double[] V2 = {5,4,3,2,1};
		Test.testDirectSolver(new FullMatrix(A2), new Vector(V2));
