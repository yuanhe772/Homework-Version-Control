...
//		String error = "Unmatching matrix and vector size for multiplication!";
//
//		// Create an assertion error
//		int len[] = {5, 4};
//		for(int i=0; i<len.length; i++) {
//			try {new SparseMatrix(len[i]).product(new Vector(len[len.length-1-i]));}
//
...
//		// The expected error message
//		String I[] = new String[2];
//		String error = "Unmatching matrix size for matrix multiplication!";
//
//		// Create an assertion error
//		int len[] = {5, 4};
//		for(int i=0; i<len.length; i++) {
//			try {new SparseMatrix(len[i]).leftMult(new SparseMatrix(len[len.length-1-i]));}
//
//			// Assign the error message to String I[];
//			catch(AssertionError e) {I[i] = e.getMessage();}
//		}
...
//		// The expected error message
//		String I[] = new String[2];
//		String error = "Unmatching matrix size for matrix addition!";
//
//		// Create an assertion error
//		int len[] = {5, 4};
//		for(int i=0; i<len.length; i++) {
//			try {new SparseMatrix(len[i]).add(new SparseMatrix(len[len.length-1-i]), 1);}
//
//			// Assign the error message to String I[];
//			catch(AssertionError e) {I[i] = e.getMessage();}
//		}
...
//			try {sp.retrieveElement(index[i], index[i]);}
//
//			// Assign the error message to String I[];
//			catch(AssertionError e) {I[i] = e.getMessage();}
//		}
...
//		// The expected error message
//		String I[] = new String[2];
//		String error = "IndexOutOfBound!";
//
//		// Create an assertion error
//		int index[] = {-1, 5};
//		for(int i=0; i<index.length; i++) {
//			try {sp.matrixSetter(index[i], index[i], 0);}
//
//			// Assign the error message to String I[];
//			catch(AssertionError e) {I[i] = e.getMessage();}
//		}
